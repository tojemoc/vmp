...
process_video() {
    ...
    if [ "$should_process_video" = "1" ]; then
        ...
        if [ "$need_encode" = true ]; then
            ...
            "${FFMPEG_VAAPI_BASE[@]}" -i "$INPUT_PATH" -r 30 \
