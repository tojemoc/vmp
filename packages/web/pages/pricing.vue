  ...
  <div class="min-h-screen overflow-x-hidden bg-gray-50 dark:bg-gray-950">
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 py-10 space-y-6">
      ...
      >
        ...
        />
        <SubscriptionCheckoutPanel v-else return-path="/pricing" embedded active />
      </div>
    </div>
  </div>
</template>
...
<script setup lang="ts">
  ...
  const pageSubtitle = computed(() =>
    showRelinkFlow.value ? strings.accountRelinkBannerBody : strings.checkoutPremiumSubtitle,
  );
