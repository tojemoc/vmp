...
export type StringsDefinition = {
  ...
  authVerifyNativeIosSafariTitle: string;
  authVerifyNativeIosSafariBody: string;
  authVerifyNativeIosSafariContinue: string;
  authVerifyNativeIosInsecureOffer: string;
  authVerifyNativeIosInsecureWarnTitle: string;
  authVerifyNativeIosInsecureWarnBody: string;
  authVerifyNativeIosInsecureWarnContinue: string;
  authVerifyNativeIosInsecureWarnCancel: string;
  authVerifyNativeIosInsecureConfirmTitle: string;
  authVerifyNativeIosInsecureConfirmBody: string;
  authVerifyNativeIosInsecureCheckbox: string;
  authVerifyNativeIosInsecureConfirm: string;
  authVerifyNativeIosInsecureWorking: string;
  authVerifyNativeIosInsecureFailed: string;
  ...
  irlEventsTitle: string;
  irlEventsIntro: string;
  irlEventsEmpty: string;
  irlEventsLoadFailed: string;
  irlEventsClubOnly: string;
  irlEventsOpen: string;
  irlEventsRsvp: string;
  irlEventsCancelRsvp: string;
  irlEventsRsvping: string;
  irlEventsRsvpFailed: string;
  irlEventsFull: string;
  irlEventsClubRequired: string;
  irlEventsCheckInCode: string;
  irlEventsCheckedIn: string;
  irlEventsCapacity: (taken: number, capacity: number) => string;
  irlEventsUnlimited: (taken: number) => string;
  yourAccount: string;
  currentPlan: string;
  ...
  checkoutTermsAcceptLabel: string;
  checkoutTermsLearnMore: string;
  checkoutTermsRequired: string;
  accountDeleteTitle: string;
  accountDeleteIntro: string;
  accountDeleteInvoiceNote: string;
  accountDeleteImmediateCancelNote: string;
  accountDeleteRequest: string;
  accountDeleteRequesting: string;
  accountDeleteRequestSent: string;
  accountDeleteRequestFailed: string;
  accountDeleteConfirmPhraseLabel: string;
  accountDeleteConfirmPhraseHint: string;
  accountDeleteConfirm: string;
  accountDeleteConfirming: string;
  accountDeleteConfirmFailed: string;
  accountDeleteDone: string;
  copy: string;
  copied: string;
  ...
  continueWatchingIntro: string;
  continueWatchingIntroLapsed: string;
  continueWatchingEmpty: string;
  continueWatchingRemove: string;
  continueWatchingRemoving: string;
  continueWatchingLoadFailed: string;
  continueWatchingLoadNetworkError: string;
  continueWatchingRemoveFailed: string;
  continueWatchingProgress: (percent: number) => string;
