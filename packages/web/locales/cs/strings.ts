...
export const strings: StringsDefinition = {
  ...
  loginSubtitle: 'Pošleme vám e-mailem potvrzovací kód a odkaz na přihlášení. Heslo není potřeba.',
  loginEmailLabel: 'E-mailová adresa',
  loginEmailPlaceholder: 'vy@priklad.cz',
  loginSendLink: 'Odeslat potvrzovací kód',
  loginSending: 'Odesílá se…',
  loginMagicLinkSent: '✓ Zkontrolujte svou schránku — potvrzovací kód a odkaz na přihlášení jsou na cestě.',
  ...
  loginInlineHint: 'Pošlete kód e-mailem a zůstaňte na této stránce, nebo otevřete odkaz ze schránky.',
  loginFullPageLink: 'Otevřít celou stránku přihlášení',
  ...
  checkoutSignInBefore: 'Přihlaste se níže a pokračujte v platbě.',
  checkoutAuthEmailLabel: 'E-mail',
  checkoutAuthEmailPlaceholder: 'vas@email.cz',
  checkoutAuthSendCode: 'Poslat potvrzovací kód',
  checkoutAuthSending: 'Odesílám…',
  checkoutAuthCodeSent:
    'Zkontrolujte e-mail — najdete v něm potvrzovací kód (i přihlašovací odkaz).',
  checkoutAuthCodeLabel: 'Potvrzovací kód',
  checkoutAuthCodePlaceholder: '6místný kód',
  checkoutAuthVerifyCode: 'Pokračovat',
  checkoutAuthVerifying: 'Ověřuji…',
  checkoutAuthTotpLabel: 'Kód z autentizátoru',
  checkoutAuthTotpHint: 'Zadejte 6místný kód z autentizační aplikace.',
  checkoutAuthChangeEmail: 'Použít jiný e-mail',
  checkoutAuthResend: 'Poslat kód znovu',
  checkoutPromoToggle: 'Máte promo kód?',
  checkoutPromoHide: 'Skrýt promo kód',
