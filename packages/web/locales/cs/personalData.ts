  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Pokud jste přihlášeni, ukládáme také vaši poslední pozici přehrávání u jednotlivých on-demand videí (VOD) na našich serverech, abychom mohli pokračovat tam, kde jste skončili. Pozice se aktualizují občas během sledování a při opuštění stránky — ne při každém posunu na časové ose. Anonymní návštěvníci serverové obnovení pozice nedostanou. Uloženou pozici u konkrétního videa můžete odstranit v sekci Pokračovat ve sledování na stránce účtu. Všechny uložené pozice se odstraní při smazání účtu.',
      ],
    },
    {
      id: 'rights',
