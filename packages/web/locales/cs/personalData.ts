  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Pokud jste přihlášeni, ukládáme také vaši poslední pozici přehrávání u jednotlivých on-demand videí (VOD) na našich serverech, abychom mohli pokračovat tam, kde jste skončili. Pozice se aktualizují občas během sledování a při opuštění stránky — ne při každém posunu na časové ose. Anonymní návštěvníci serverové obnovení pozice nedostanou. Uloženou pozici u konkrétního aktuálně dostupného videa můžete odstranit v sekci Pokračovat ve sledování na stránce účtu. Smazání účtu a souvisejících osobních údajů — včetně všech uložených pozic přehrávání — můžete požádat e-mailem na adresu podpory uvedenou v dolní části této stránky.',
      ],
    },
    {
      id: 'rights',
