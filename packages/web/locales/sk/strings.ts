...
export const strings: StringsDefinition = {
  ...
  checkoutSignInBefore: 'Prihláste sa nižšie a pokračujte v platbe.',
  checkoutAuthEmailLabel: 'E-mail',
  checkoutAuthEmailPlaceholder: 'vas@email.sk',
  checkoutAuthSendCode: 'Poslať potvrdzovací kód',
  checkoutAuthSending: 'Odosielam…',
  checkoutAuthCodeSent:
    'Skontrolujte e-mail — nájdete v ňom potvrdzovací kód (aj prihlasovací odkaz).',
  checkoutAuthCodeLabel: 'Potvrdzovací kód',
  checkoutAuthCodePlaceholder: '6-miestny kód',
  checkoutAuthVerifyCode: 'Pokračovať',
  checkoutAuthVerifying: 'Overujem…',
  checkoutAuthTotpLabel: 'Kód z autentifikátora',
  checkoutAuthTotpHint: 'Zadajte 6-miestny kód z autentifikačnej aplikácie.',
  checkoutAuthChangeEmail: 'Použiť iný e-mail',
  checkoutAuthResend: 'Poslať kód znova',
  checkoutPromoToggle: 'Máte promo kód?',
  checkoutPromoHide: 'Skryť promo kód',
