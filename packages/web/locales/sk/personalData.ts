  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Ak je v Admin → System zapnutý Google Tag Manager, môžu sa načítať ďalšie marketingové alebo meracie tagy, ktoré v kontajneri nakonfigurujete. GTM je predvolene vypnutý.',
      ],
    },
    {
      id: 'interaction',
      ...
      paragraphs: [
        ...
        'Vašu interakciu nepoužívame ako súhlas s nesúvisiacimi marketingovými trackermi. Voliteľné reklamné nástroje, ktoré nie sú nevyhnutné, vyžadujú súhlas — vrátane tagov načítaných cez Google Tag Manager, ak ho administrátor zapne. Plná produktová analytika PostHog (cookies, prepojenie účtu) vyžaduje výslovný súhlas v banneri. Ak odmietnete, zhromažďujú sa len návštevy bez ukladania do prehliadača pomocou hash.',
      ],
    },
    {
      id: 'storage-table',
