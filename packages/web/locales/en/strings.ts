...
export const strings: StringsDefinition = {
  ...
  offlineDownloadPause: 'Pause download',
  offlineDownloadRemove: 'Remove download',
  offlineDownloadUpdate: 'Update download',
  ...
  offlineDownloadStatusPaused: 'Paused',
  offlineDownloadStatusFailed: 'Failed',
  ...
  checkoutSignInBefore: 'Sign in below to continue to payment.',
  checkoutAuthEmailLabel: 'Email',
  checkoutAuthEmailPlaceholder: 'you@example.com',
  checkoutAuthSendCode: 'Send confirmation code',
  checkoutAuthSending: 'Sending…',
  checkoutAuthCodeSent: 'Check your email for a confirmation code (and sign-in link).',
  checkoutAuthCodeLabel: 'Confirmation code',
  checkoutAuthCodePlaceholder: '6-digit code',
  checkoutAuthVerifyCode: 'Continue',
  checkoutAuthVerifying: 'Verifying…',
  checkoutAuthTotpLabel: 'Authenticator code',
  checkoutAuthTotpHint: 'Enter the 6-digit code from your authenticator app.',
  checkoutAuthChangeEmail: 'Use a different email',
  checkoutAuthResend: 'Resend code',
  checkoutPromoToggle: 'Have a promo code?',
  checkoutPromoHide: 'Hide promo code',
