...
const strings = {
  ...
  ctaBodyDefault: 'Upgrade to unlock complete videos and premium features.',
  textSplitTitleDefault: 'Why upgrade?',
  textSplitBodyDefault: 'Get full-length videos and uninterrupted viewing.',
  textSplitCompareTitle: 'Free vs Premium',
  textSplitCompareBody: 'Free users can watch previews, premium users get complete access to every upload.',
