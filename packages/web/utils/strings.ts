...
const strings = {
  ...
  checkoutPayWithCard: (price: string) => `Pay ${price} with your card`,
  checkoutTabWallet: 'Wallet',
  checkoutTabCard: 'Card',
  checkoutTabBank: 'Bank',
  checkoutPaymentMethodTabs: 'Payment method',
  checkoutStripeLoading: 'Loading secure checkout…',
  checkoutStripeProcessing: 'Processing…',
  checkoutStripeOrPayWithCard: 'or pay with card',
  ...
  checkoutBlurbEmbedded: 'Pay with Apple Pay, Google Pay, or card. Cancel any time.',
  checkoutBlurbDefault: 'Secure checkout. Cancel any time.',
  checkoutBlurbStripe: 'Secure checkout via Stripe. Cancel any time.',
  checkoutBlurbGoCardless: 'Secure checkout via GoCardless. Cancel any time.',
  checkoutBlurbBoth: 'Secure checkout via Stripe or GoCardless. Cancel any time.',
