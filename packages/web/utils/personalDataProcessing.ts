/**
 * Structured copy for /personal-data (GDPR Art. 13/14 transparency).
 * English first — primary audience includes Czechia and Slovakia; i18n can mirror this module.
 */
