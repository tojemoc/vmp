<template>
  ...
  >
    <summary
      class="cursor-pointer list-none px-4 py-3 font-semibold text-gray-900 dark:text-white flex items-center justify-between gap-2 select-none"
    >
      <span>{{ title }}</span>
      <span
        class="text-gray-400 dark:text-gray-500 text-sm group-open:rotate-180 transition-transform"
        aria-hidden="true"
        >▾</span
      >
    </summary>
