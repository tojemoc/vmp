    ...
    <div v-if="activeSubTab === 'compose'" class="grid gap-6 lg:grid-cols-2">
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-2 text-sm">
          ...
          <button type="button" class="px-2 py-1 rounded" :class="bodyMode === 'html' ? 'bg-blue-600 text-white' : 'border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-900'" @click="setBodyMode('html')">HTML</button>
          <button type="button" class="px-2 py-1 rounded" :class="bodyMode === 'markdown' ? 'bg-blue-600 text-white' : 'border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-900'" @click="setBodyMode('markdown')">Markdown</button>
        </div>
