    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              class="sticky top-0 z-10 flex items-center justify-between gap-3 px-5 py-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900"
            >
            ...
            <form class="p-5 space-y-4" @submit.prevent="emit('save', draft)">
              ...
              <label class="block text-sm text-gray-700 dark:text-gray-300">
                ...
                <input
                  ...
                  type="text"
                  required
                  class="mt-1 w-full px-3 py-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white font-mono text-sm"
                >
              </label>
              <label class="block text-sm text-gray-700 dark:text-gray-300">
                Sort order
              ...
              <label class="block text-sm text-gray-700 dark:text-gray-300">
                Rec. recency bias
                <input
                  v-model.number="draft.recommendation_recency_bias"
                  type="number"
                  min="0"
                  step="0.1"
                  class="mt-1 w-full px-3 py-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white"
              ...
              <label class="block text-sm text-gray-700 dark:text-gray-300">
                Rec. low-views boost
                <input
                  v-model.number="draft.recommendation_low_views_boost"
                  type="number"
                  min="0"
                  step="0.1"
                  class="mt-1 w-full px-3 py-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white"
              ...
              >
                <input
                  v-model="draft.recommendation_category_lock"
                  type="checkbox"
                  :true-value="1"
                  :false-value="0"
              ...
              <div class="flex flex-wrap gap-2 pt-2">
                ...
                <button type="button" :class="secondaryButtonClass" @click="emit('close')">
                  Cancel
                </button>
              </div>
                ...
                <template v-else>
                  ...
                  >
                    ...
                    >
                      ...
                      <option v-for="c in otherCategories" :key="c.id" :value="c.id">
                        {{ c.name }}
                      </option>
                    </select>
                  </label>
...
<script setup lang="ts">
  ...
  const secondaryButtonClass =
    'px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 text-sm text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800';
  const secondaryButtonSmClass =
    'px-3 py-1.5 rounded border border-gray-300 dark:border-gray-600 text-sm text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800';
