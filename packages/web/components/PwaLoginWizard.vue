<template>
  ...
  >
    <div
      class="w-full max-w-md bg-gray-900 border border-gray-800 rounded-xl shadow-xl overflow-hidden"
    >
      <div class="px-5 py-4 border-b border-gray-800 flex items-start justify-between gap-3">
        <div>
          <h2 id="pwa-login-title" class="text-lg font-semibold text-white">
      ...
      <div v-if="step === 1" class="px-5 pb-5 space-y-4">
        <label for="pwa-login-email" class="block text-sm font-medium text-gray-300"
      ...
      <div v-else-if="step === 2" class="px-5 pb-5 space-y-4">
        ...
        <p v-if="pushDenied" class="text-sm text-amber-300/90 leading-relaxed">
