-- GoPay + Comgate draft provider settings (amounts in major units; currency ISO code).
...
INSERT OR IGNORE INTO admin_settings (key, value, updated_at) VALUES
  ...
  ('comgate_monthly_price', '', CURRENT_TIMESTAMP),
  ('comgate_yearly_price', '', CURRENT_TIMESTAMP),
  ('comgate_club_price', '', CURRENT_TIMESTAMP),
  ('comgate_currency', 'CZK', CURRENT_TIMESTAMP);
