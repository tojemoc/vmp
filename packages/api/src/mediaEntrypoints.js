...
export function buildEntrypointCandidates(base, videoId) {
  return [
...
export async function resolveMediaEntrypointUrl({ env, videoId }) {
...
export function buildProxyPlaylistUrl(request, playlistUrl, previewUntilSeconds) {
